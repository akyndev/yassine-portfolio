...
export default function Footer() {
  ...
  return (
    <footer className=" bg-white px-4 py-5 container mx-auto md:px-8">
      <div className="flex items-center justify-between flex-col">
        <div className="font-semibold text-xl">YASSINE.</div>
        <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0 text-center md:text-left">
      ...
      <div className="mt-8 items-center justify-between flex flex-col sm:flex-row">
        <div className="mt-4 sm:mt-0 text-sm">&copy; {new Date().getFullYear()} Yassine All rights reserved.</div>
